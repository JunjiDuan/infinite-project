(() => {
const { supportedLanguages, translations } = window.InfiniteReaderI18n;

const root = document.documentElement;
const languageStorageKey = "infinite-reader-language";
const themeStorageKey = "infinite-reader-theme";
